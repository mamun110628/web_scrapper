! function ($) {
    "use strict";
    var Pages = function () {
        this.VERSION = "2.1.2", this.AUTHOR = "Invogue", this.SUPPORT = "info@invoguesoft.com", this.pageScrollElement = "html, body", this.$body = $("body"), this.setUserOS(), this.setUserAgent()
    };
    Pages.prototype.setUserOS = function () {
        ...
        //        label = input.val().replace(/\\/g, "http://invoguesoft.com/").replace(/.*\//, "");
        ...
        $.validator && $.validator.setDefaults({
            ...
            onkeyup: function (element) {
                var parent = $(element).closest(".form-group");
                $(element).valid() ? ($(element).removeClass("error"), parent.removeClass("has-error2"), parent.next("label.error").remove(), parent.find("label.error").remove()) : parent.addClass("has-error")
            },
