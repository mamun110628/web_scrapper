...
@section('page-content')
    ...
    <div class="panel-body">
        <div class="row xl-mlr10">
            <form id="form-personal" action="{{route('newspaper.update',$newspaper->id)}}" method="post" enctype="multipart/form-data">
                 @csrf
                  @method('PATCH')
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 xl-mb30">
                    ...
                    <div class="form-group form-group-default">
                        ...
                        <input type="text" class="form-control" value="{{$newspaper->name}}" name="name" placeholder="Paper Name" required>
                           
                    </div>
                    <div class="form-group form-group-default">
                        <label>Newspaper Url</label>
                        <input type="url" class="form-control" name="url" value="{{$newspaper->url}}" placeholder="https:// website url" required>
                    </div>
<!--                    <div class="form-group form-group-default">
                    ...
                    <div class="form-group form-group-default">
                        ...
                        <input type="text" class="form-control" value="{{$newspaper->dom_element}}" name="dom_element" style="margin-top: 5px;">
                    </div>
                    <div class="form-group form-group-default">
                        <label>Status</label>
                        <select class="form-control" name="status">
                            <option value="">Select Status</option>
                            <option value="1" {{($newspaper->status == 1)?'selected':null}}>Active</option>
                            <option value="0" {{($newspaper->status == 0)?'selected':null}}>Inactive</option>
                        </select>
                    </div>
