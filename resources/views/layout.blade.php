...
<html>
  <head>
    ...
    <link href="{{url('public/assets/plugins/bootstrap-select2/select2.css')}}" rel="stylesheet" type="text/css" media="screen" />
    <link href="{{url('public/assets/plugins/switchery/css/switchery.min.css')}}" rel="stylesheet" type="text/css" media="screen" />
    <link href="{{url('public/assets/plugins/nvd3/nv.d3.min.css')}}" rel="stylesheet" type="text/css" media="screen" />
    <link href="{{url('public/assets/plugins/mapplic/css/mapplic.css')}}" rel="stylesheet" type="text/css" />
    <link href="{{url('public/assets/plugins/rickshaw/rickshaw.min.css'}}" rel="stylesheet" type="text/css" />
    <link href="{{url('public/assets/plugins/bootstrap-datepicker/css/datepicker3.css')}}" rel="stylesheet" type="text/css" media="screen">
    <link href="{{url('public/assets/plugins/jquery-metrojs/MetroJs.css')}}" rel="stylesheet" type="text/css" media="screen" />
  ...
  <body class="fixed-header dashboard menu-pin">
    ...
    <nav class="page-sidebar" data-pages="sidebar">
      ...
      <div class="sidebar-header">
        <img src="assets/img/logo_white.png" alt="logo" class="brand" data-src="assets/img/logo_white.png" data-src-retina="{{url('public/assets/img/logo_white_2x.png" width="78" height="22">
    ...
    <script src="{{url('public/assets/plugins/jquery/jquery-1.11.1.min.js" type="text/javascript"></script>
    ...
    <script src="{{url('public/assets/plugins/jquery-bez/jquery.bez.min.js"></script>
    ...
    <script type="text/javascript" src="{{url('public/assets/plugins/bootstrap-select2/select2.min.js"></script>
    ...
    <script src="{{url('public/assets/plugins/nvd3/lib/d3.v3.js" type="text/javascript"></script>
    <script src="{{url('public/assets/plugins/nvd3/nv.d3.min.js" type="text/javascript"></script>
    <script src="{{url('public/assets/plugins/nvd3/src/utils.js" type="text/javascript"></script>
    <script src="{{url('public/assets/plugins/nvd3/src/tooltip.js" type="text/javascript"></script>
    <script src="{{url('public/assets/plugins/nvd3/src/interactiveLayer.js" type="text/javascript"></script>
    <script src="{{url('public/assets/plugins/nvd3/src/models/axis.js" type="text/javascript"></script>
    <script src="{{url('public/assets/plugins/nvd3/src/models/line.js" type="text/javascript"></script>
    <script src="{{url('public/assets/plugins/nvd3/src/models/lineWithFocusChart.js" type="text/javascript"></script>
    <script src="{{url('public/assets/plugins/mapplic/js/hammer.js"></script>
    <script src="{{url('public/assets/plugins/mapplic/js/jquery.mousewheel.js"></script>
    <script src="{{url('public/assets/plugins/mapplic/js/mapplic.js"></script>
    <script src="{{url('public/assets/plugins/rickshaw/rickshaw.min.js"></script>
    <script src="{{url('public/assets/plugins/jquery-metrojs/MetroJs.min.js" type="text/javascript"></script>
    <script src="{{url('public/assets/plugins/jquery-sparkline/jquery.sparkline.min.js" type="text/javascript"></script>
    <script src="{{url('public/assets/plugins/skycons/skycons.js" type="text/javascript"></script>
